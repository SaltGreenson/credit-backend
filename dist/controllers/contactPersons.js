...
exports.getContactPersons = void 0;
...
const getContactPersons = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const contactPersonRep = data_source_1.dataSource.getRepository(ContactPerson_entity_1.ContactPersonEntity);
    const contactPersons = yield contactPersonRep.find();
